...
public class Main extends ActionBarActivity implements IPost {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MiTarea miTarea=new MiTarea(this);
           miTarea.execute("http://jsonplaceholder.typicode.com/posts/1");
    ...
    @Override
    public void receive(Post s) {

        System.err.println("ID: "+s.getId());
        System.err.println("userID: "+s.getUserId());
        System.err.println("Title: "+s.getTitle());
        System.err.println("body: "+s.getBody());
    }
